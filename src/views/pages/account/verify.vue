    ...
    tryToLogIn() {
      ...
      if (this.$v.$invalid) {
        ...
        let loginData = {
         ...
         this.$router.push(
                  this.$route.query.redirectFrom || { path: `verify-otp/${this.email}/${this.mobile}` }
                );
        return;
                  ...
                  <div class="col-lg-9">
                    <div>
                      <div class="text-center">
                        ...
                        <p class="text-muted">Verify yourself  continue to TT &amp; RTGS Portal.</p>
                      </div>
                      ...
                      <div class="p-2 mt-5">
                        <form class="form-horizontal" @submit.prevent="tryToLogIn">
                          ...
                          <div class="form-group auth-form-group-custom mb-4">
                            ...
                            />
                            <div
                              v-if="submitted && !$v.mobile.required"
                          ...
                          <!-- <div class="mt-4 text-center">
                            <router-link tag="a" to="/forgot-mobile" class="text-muted">
                              <i class="mdi mdi-lock mr-1"></i> Forgot your mobile?
                            </router-link>
                          </div> -->
                        </form>
                      </div>
